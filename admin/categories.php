                          ...
                          <?php
                            foreach($tags as $tag){?>
                              <tr>
                                ...
                                <td><a href="./editCategory.php?id=<?php echo $tag['category_id'];?>"><img src="./images/edit.png" alt="Edit"></a></td>
                                <td><form action="" method="post">
                                  <input type="hidden" name="id" value="<?php echo $tag['category_id'];?>">
                                  <button type="submit" name="delete" value="delete"><img src="./images/delete.png" alt="Delete"></button></form>
                                </td>
                              </tr>
                          <?php }?>
                      </tbody>
