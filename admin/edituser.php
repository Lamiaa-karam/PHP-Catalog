...
$active = 0;
$email = $_GET['email'];
$row =  retrieveUserData($conn, $email);
if(isset($_POST['update'])){
	...
	updateUser($conn, $fullname, $username, $email, $active, $pass);	
}
?>
									...
									<form id="demo-form2" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="fullname" value="<?php echo $row['fullname'];?>" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" name="username" value="<?php echo $row['username'];?>" required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											<label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Email <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="email" class="form-control" type="email" name="email" value="<?php echo $row['email'];?>" required="required">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">																				
												<label>
													<?php if($row['active'] == 1){?>
														<input type="checkbox" name="active" class="flat" checked="checked"><?php }
														else{?>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="password" id="password" name="password" value="<?php echo $row['password'];?>" required="required" class="form-control">
											</div>
										</div>
