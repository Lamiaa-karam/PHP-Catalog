...
if(isset($_POST['add'])){
	...
	checkPhoto($conn, $title, $date, $image, $license, $dim, $format, $active, $tag_id);
} 
$data = retrieveCategories($conn);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
									...
									<form id="demo-form2" method="post" action="#" data-parsley-validate class="form-horizontal form-label-left">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="photo-date" name="photo_date" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="title" name="photo_title" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
