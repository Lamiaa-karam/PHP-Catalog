...
$row = retrieveCategoryData($id, $conn);
if(isset($_POST['submit'])){
	if(!empty($_POST['category'])){
		$id = $_POST['id'];
		$cat = $_POST['category'];
		updateCategory($conn, $id, $cat);
	}
}?>
<!DOCTYPE html>
<html lang="en">
									...
									<form id="demo-form2" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" name="category" value="<?php echo $row['category'];?>" required="required" class="form-control ">
											</div>
										</div>
