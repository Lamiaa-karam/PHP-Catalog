...
$user1 = retrieveUserData($conn, 'Ryan@gmail.com');
$user2 = retrieveUserData($conn,'Catherine@gmail.com');
$user3 = retrieveUserData($conn, 'Johnny@gmail.com');
$user4 = retrieveUserData($conn, 'George@gmail.com');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container-fluid tm-mt-60">
        ...
        <div class="row tm-mb-74 tm-people-row">        
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="<?php echo $user1['image'];?>" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4"><?php echo $user1['username'];?></h2>
                <h3 class="tm-text-secondary h5 mb-4"><?php echo $user1['role'];?></h3>
                <p class="mb-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="<?php echo $user2['image'];?>" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4"><?php echo $user2['username'];?></h2>
                <h3 class="tm-text-secondary h5 mb-4"><?php echo $user2['role'];?></h3>
                <p class="mb-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="<?php echo $user3['image'];?>" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4"><?php echo $user3['username'];?></h2>
                <h3 class="tm-text-secondary h5 mb-4"><?php echo $user3['role'];?></h3>
                <p class="mb-4">
                    Sed faucibus nec velit finibus accumsan. Sed varius augue et leo pharetra, in varius lacus eleifend. Quisque ut eleifend lacus.
                </p>
                <ul class="tm-social pl-0 mb-0">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="<?php echo $user4['image'];?>" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4"><?php echo $user4['username'];?></h2>
                <h3 class="tm-text-secondary h5 mb-4"><?php echo $user4['role'];?></h3>
                <p class="mb-4">
